...
#define GENERATE_CONFIG_ITEM(key, value)	key = value
...
#ifdef EX_PARAM_CONFIG_ITEM_KEY_1
#ifdef EX_PARAM_CONFIG_ITEM_VALUE_1
GENERATE_CONFIG_ITEM(EX_PARAM_CONFIG_ITEM_KEY_1, EX_PARAM_CONFIG_ITEM_VALUE_1);
#endif
#endif

#ifdef EX_PARAM_CONFIG_ITEM_KEY_2
#ifdef EX_PARAM_CONFIG_ITEM_VALUE_2
GENERATE_CONFIG_ITEM(EX_PARAM_CONFIG_ITEM_KEY_2, EX_PARAM_CONFIG_ITEM_VALUE_2);
#endif
#endif

#ifdef EX_PARAM_CONFIG_ITEM_KEY_3
#ifdef EX_PARAM_CONFIG_ITEM_VALUE_3
GENERATE_CONFIG_ITEM(EX_PARAM_CONFIG_ITEM_KEY_3, EX_PARAM_CONFIG_ITEM_VALUE_3);
#endif
#endif

// #####匹配的芯片版本,请勿随意改动 目前只有BR30添加了版本号区分，后续其他CPU有添加的话在对应的isd_config_rule.c加上######
[CHIP_VERSION]
SUPPORTED_LIST = A, B, D; //匹配的芯片版本
...
#ifdef CONFIG_CUSTOM_EX_FLASH_PARAM
EX_FLASH = CONFIG_CUSTOM_EX_FLASH_PARAM;
#endif

#ifdef EX_SYS_CONFIG_ITEM_KEY_1
#ifdef EX_SYS_CONFIG_ITEM_VALUE_1
GENERATE_CONFIG_ITEM(EX_SYS_CONFIG_ITEM_KEY_1, EX_SYS_CONFIG_ITEM_VALUE_1);
#endif
#endif

#ifdef EX_SYS_CONFIG_ITEM_KEY_2
#ifdef EX_SYS_CONFIG_ITEM_VALUE_2
GENERATE_CONFIG_ITEM(EX_SYS_CONFIG_ITEM_KEY_2, EX_SYS_CONFIG_ITEM_VALUE_2);
#endif
#endif

#ifdef EX_SYS_CONFIG_ITEM_KEY_3
#ifdef EX_SYS_CONFIG_ITEM_VALUE_3
GENERATE_CONFIG_ITEM(EX_SYS_CONFIG_ITEM_KEY_3, EX_SYS_CONFIG_ITEM_VALUE_3);
#endif
#endif
