...
static const uint8_t hogp_profile_data[] = {
    ...
    #if !defined LITEEMF_ENABLED || (defined BLE_HID_SUPPORT && BLE_HID_SUPPORT)
    //////////////////////////////////////////////////////
    //
    ...
    0x0a, 0x00, 0x02, 0x00, 0x40, 0x00, 0x08, 0x29, 0x06, 0x01,
     ...
     /* CHARACTERISTIC,  2a4d, READ | WRITE | WRITE_WITHOUT_RESPONSE | DYNAMIC, */
    // 0x0041 CHARACTERISTIC 2a4d READ | WRITE | WRITE_WITHOUT_RESPONSE | DYNAMIC 
    0x0d, 0x00, 0x02, 0x00, 0x41, 0x00, 0x03, 0x28, 0x0e, 0x42, 0x00, 0x4d, 0x2a,
    // 0x0042 VALUE 2a4d READ | WRITE | WRITE_WITHOUT_RESPONSE | DYNAMIC  
    0x08, 0x00, 0x0e, 0x01, 0x42, 0x00, 0x4d, 0x2a,

    /* 0x0043 REPORT_REFERENCE,02,02 */
    0x0a, 0x00, 0x02, 0x00, 0x43, 0x00, 0x08, 0x29, 0x02, 0x02,

     /* CHARACTERISTIC,  2a4d, READ | WRITE | WRITE_WITHOUT_RESPONSE | DYNAMIC, */
    // 0x0044 CHARACTERISTIC 2a4d READ | WRITE | WRITE_WITHOUT_RESPONSE | DYNAMIC 
    0x0d, 0x00, 0x02, 0x00, 0x44, 0x00, 0x03, 0x28, 0x0e, 0x45, 0x00, 0x4d, 0x2a,
    // 0x0045 VALUE 2a4d READ | WRITE | WRITE_WITHOUT_RESPONSE | DYNAMIC  
    0x08, 0x00, 0x0e, 0x01, 0x45, 0x00, 0x4d, 0x2a,

    /* 0x0046 REPORT_REFERENCE,03,02 */
    0x0a, 0x00, 0x02, 0x00, 0x46, 0x00, 0x08, 0x29, 0x03, 0x02,

     /* CHARACTERISTIC,  2a4b, READ | DYNAMIC, */
    // 0x0047 CHARACTERISTIC 2a4b READ | DYNAMIC 
    0x0d, 0x00, 0x02, 0x00, 0x47, 0x00, 0x03, 0x28, 0x02, 0x48, 0x00, 0x4b, 0x2a,
    // 0x0048 VALUE 2a4b READ | DYNAMIC  
    0x08, 0x00, 0x02, 0x01, 0x48, 0x00, 0x4b, 0x2a,

     /* CHARACTERISTIC,  2a33, READ | WRITE | NOTIFY, */
    // 0x0049 CHARACTERISTIC 2a33 READ | WRITE | NOTIFY 
    0x0d, 0x00, 0x02, 0x00, 0x49, 0x00, 0x03, 0x28, 0x1a, 0x4a, 0x00, 0x33, 0x2a,
    // 0x004a VALUE 2a33 READ | WRITE | NOTIFY  
    0x08, 0x00, 0x1a, 0x00, 0x4a, 0x00, 0x33, 0x2a,
    ...
    // 0x004c CHARACTERISTIC 2a4a READ | DYNAMIC 
    0x0d, 0x00, 0x02, 0x00, 0x4c, 0x00, 0x03, 0x28, 0x02, 0x4d, 0x00, 0x4a, 0x2a,
    // 0x004d VALUE 2a4a READ | DYNAMIC  
    0x08, 0x00, 0x02, 0x01, 0x4d, 0x00, 0x4a, 0x2a,

     /* CHARACTERISTIC,  2a4c, WRITE_WITHOUT_RESPONSE | DYNAMIC, */
    // 0x004e CHARACTERISTIC 2a4c WRITE_WITHOUT_RESPONSE | DYNAMIC 
    0x0d, 0x00, 0x02, 0x00, 0x4e, 0x00, 0x03, 0x28, 0x04, 0x4f, 0x00, 0x4c, 0x2a,
    // 0x004f VALUE 2a4c WRITE_WITHOUT_RESPONSE | DYNAMIC  
    0x08, 0x00, 0x04, 0x01, 0x4f, 0x00, 0x4c, 0x2a,
    #endif

    //////////////////////////////////////////////////////
    //
    // 0x0050 PRIMARY_SERVICE  ae40
    //
    //////////////////////////////////////////////////////
    0x0a, 0x00, 0x02, 0x00, 0x50, 0x00, 0x00, 0x28, 0x40, 0xae,

     /* CHARACTERISTIC,  ae41, WRITE_WITHOUT_RESPONSE | DYNAMIC, */
    // 0x0051 CHARACTERISTIC ae41 WRITE_WITHOUT_RESPONSE | DYNAMIC 
    0x0d, 0x00, 0x02, 0x00, 0x51, 0x00, 0x03, 0x28, 0x04, 0x52, 0x00, 0x41, 0xae,
    // 0x0052 VALUE ae41 WRITE_WITHOUT_RESPONSE | DYNAMIC  
    0x08, 0x00, 0x04, 0x01, 0x52, 0x00, 0x41, 0xae,

     /* CHARACTERISTIC,  ae42, NOTIFY, */
    // 0x0053 CHARACTERISTIC ae42 NOTIFY 
    0x0d, 0x00, 0x02, 0x00, 0x53, 0x00, 0x03, 0x28, 0x10, 0x54, 0x00, 0x42, 0xae,
    // 0x0054 VALUE ae42 NOTIFY  
    0x08, 0x00, 0x10, 0x00, 0x54, 0x00, 0x42, 0xae,
...
#define ATT_CHARACTERISTIC_2a4d_08_VALUE_HANDLE 0x0042
#define ATT_CHARACTERISTIC_2a4d_09_VALUE_HANDLE 0x0045
#define ATT_CHARACTERISTIC_2a4b_01_VALUE_HANDLE 0x0048
#define ATT_CHARACTERISTIC_2a33_01_VALUE_HANDLE 0x004a
#define ATT_CHARACTERISTIC_2a33_01_CLIENT_CONFIGURATION_HANDLE 0x004b
#define ATT_CHARACTERISTIC_2a4a_01_VALUE_HANDLE 0x004d
#define ATT_CHARACTERISTIC_2a4c_01_VALUE_HANDLE 0x004f
#define ATT_CHARACTERISTIC_ae41_01_VALUE_HANDLE 0x0052
#define ATT_CHARACTERISTIC_ae42_01_VALUE_HANDLE 0x0054
#define ATT_CHARACTERISTIC_ae42_01_CLIENT_CONFIGURATION_HANDLE 0x0055
...
#define HID_REPORT_ID_02_RECIEVE_HANDLE    ATT_CHARACTERISTIC_2a4d_08_VALUE_HANDLE
#define HID_REPORT_ID_03_RECIEVE_HANDLE    ATT_CHARACTERISTIC_2a4d_09_VALUE_HANDLE
