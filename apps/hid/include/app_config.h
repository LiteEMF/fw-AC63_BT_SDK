...
//edr sniff模式选择; sniff参数需要调整,移植可具体参考app_keyboard.c
	...
	#ifndef SNIFF_MODE_RESET_ANCHOR
	#define SNIFF_MODE_RESET_ANCHOR             1
	#endif
#elif CONFIG_APP_MOUSE_SINGLE || CONFIG_APP_MOUSE_DUAL || CONFIG_APP_STANDARD_KEYBOARD || CONFIG_APP_REMOTE_CONTROL //|| CONFIG_APP_KEYBOARD
